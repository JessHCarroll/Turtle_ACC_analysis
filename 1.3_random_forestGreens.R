...
library(dplyr)
library(tidyr)
input_data <- paste0("C:/Users/xcarrj/Desktop/turtleacc_analysis/greens/lab_accdata/")

setwd("C:/Users/xcarrj/Desktop/turtleacc_analysis/greens")
...
for (f in 1:nrow(forest)){
  ...
  data$pango_seg <- sub(" ", "", data$pango_seg)
  ...
  #data[data$behaviour== "Surface_biting",]$behaviour<-"biting"
...
write.csv(forest, "C:/Users/xcarrj/Desktop/turtleacc_analysis/greens/RF_accuracy_results.csv")
